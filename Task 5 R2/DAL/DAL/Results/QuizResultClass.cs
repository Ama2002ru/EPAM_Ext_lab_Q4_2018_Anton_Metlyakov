namespace DAL
{
    ...
    /// </summary>
    public class QuizResultClass : BaseRepositoryClass<AnswerClass>, IItem
    {
        /// <summary>
        /// ID в БД результата квиза пользователя 
        /// </summary>
        ...
        /// </summary>
        public PersonClass AssignedBy { get; set; }

        public QuizStatusEnum QuizStatusEnum { get; set; }

        /// <summary>
        /// Удаление из БД - допустимо ли ?
        /// </summary>
        public bool Delete()
        {
            return false;
