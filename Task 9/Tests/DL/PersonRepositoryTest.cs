namespace Tests.DL
{
    ...
    public class PersonRepositoryTest
    {
        ...
        public void TestGetAll()
        {
            ...
            // ki. у тебя есть прекрасный метод TestSave. Почему бы из него не вынести генерацию массива пользователей в отдельный метод и здесь сравнивать получаемые значения с тем, что этот метод будет генерировать?
            int id = 1;
            people.LoadPersons();
