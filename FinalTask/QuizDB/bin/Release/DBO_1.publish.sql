...
GO
PRINT N'Dropping [dbo].[FK2_M_QUIZ_RESULTS]...';


GO
ALTER TABLE [dbo].[M_QUIZ_RESULTS] DROP CONSTRAINT [FK2_M_QUIZ_RESULTS];
...
GO
ALTER TABLE [DBO].[M_QUIZ_RESULTS] WITH NOCHECK
...
GO
ALTER TABLE [DBO].[M_QUIZ_RESULTS] WITH CHECK CHECK CONSTRAINT [FK2_M_QUIZ_RESULTS];
